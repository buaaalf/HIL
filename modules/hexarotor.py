...
class Controls(object):
    ...
    def send_to_jsbsim(self, jsb_console):
        jsb_console.send('set %s %s\n' % ('fcs/throttle-cmd-norm', self.motor_0/10))

        jsb_console.send('set %s %s\n' % ('fcs/throttle-cmd-norm[1]', self.motor_1/10))

        jsb_console.send('set %s %s\n' % ('fcs/throttle-cmd-norm[2]', self.motor_2/10))

        jsb_console.send('set %s %s\n' % ('fcs/throttle-cmd-norm[3]', self.motor_3/10))

        jsb_console.send('set %s %s\n' % ('fcs/throttle-cmd-norm[4]', self.motor_4 / 10))

        jsb_console.send('set %s %s\n' % ('fcs/throttle-cmd-norm[5]', self.motor_5 / 10))
