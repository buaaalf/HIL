...
class Controls(object):
    ...
    def send_to_jsbsim(self, jsb_console):
        jsb_console.send('set %s %s\n' % ('fcs/throttle-cmd-norm', self.motor_2/10))
        #print str(self.motor_0/10)
        jsb_console.send('set %s %s\n' % ('fcs/throttle-cmd-norm[1]', self.motor_3/10))
        #print str(self.motor_1/10)
        jsb_console.send('set %s %s\n' % ('fcs/throttle-cmd-norm[2]', self.motor_0/10))
        #print str(self.motor_2/10)
        jsb_console.send('set %s %s\n' % ('fcs/throttle-cmd-norm[3]', self.motor_1/10))
        #print str(self.motor_3/10)
